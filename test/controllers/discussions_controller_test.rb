...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { aspect_id: @discussion.aspect_id, link: @discussion.link, name: @discussion.name } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { aspect_id: @discussion.aspect_id, link: @discussion.link, name: @discussion.name } }
